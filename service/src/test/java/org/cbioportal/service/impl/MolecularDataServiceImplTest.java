...
public class MolecularDataServiceImplTest extends BaseServiceImplTest {
    ...
    public void getMolecularData() throws Exception {
        ...
        // Mockito.when(molecularDataRepository.getGeneMolecularAlterations(MOLECULAR_PROFILE_ID, null, entrezGeneIds, 
    ...
    public void getMetaMolecularData() throws Exception {
        ...
        // List<Integer> entrezGeneIds = new ArrayList<>();
        // entrezGeneIds.add(ENTREZ_GENE_ID_1);
        // Mockito.when(molecularDataRepository.getGeneMolecularAlterations(MOLECULAR_PROFILE_ID, null, entrezGeneIds, "ID"))
