...
import org.cbioportal.web.config.PortalUserDetailsService;
...
public class TokenUserDetailsAuthenticationProvider extends AbstractUserDetailsAuthenticationProvider {
    ...
    private PortalUserDetailsService tokenUserDetailsService;

    public TokenUserDetailsAuthenticationProvider(PortalUserDetailsService userDetailsService) {
        this.tokenUserDetailsService = userDetailsService;
    }
    ...
    protected UserDetails retrieveUser(String username, UsernamePasswordAuthenticationToken authentication)
        throws AuthenticationException {
        System.out.print("\n\n>>> In TokenUserDetailsAuthenticationProvider");
        LOG.debug("retrieveUser(), username - " + username);
        System.out.println("username is  " +  username);
        return this.tokenUserDetailsService.loadUserByUsername(username);
    }
